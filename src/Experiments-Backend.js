...
var $pkg = $core.addPackage("Experiments-Backend");
$pkg.transport = {"type":"amd","amdNamespace":"amber-experiments"};

$core.addClass("ExperimentsBackend", $globals.Object, "Experiments-Backend");
$core.addMethod(
$core.method({
