...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Experiments.st', 'src/Experiments-Backend.st', // list all sources in dependency order
                    'src/Experiments-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-experiments',
